...
# 			break
# 			
# def plotRecoveredLightcurves(lc_population, lightcurve_settings, population_settings):
# 
# 	goto_colours = {'gotoL': 'goldenrod', 'gotoR': 'firebrick', 'gotoG': 'limegreen', 'gotoB': 'royalblue'}
# 	counter = 0
# 	
...
# 			print(row)
# 		
# 			lc_properties = lc_population[row['transient_id']]['lightcurves']
# 		
# 			for flt in lightcurve_settings['filters']:
# 			
# 				tobs = lc_properties[flt]['tobs']
